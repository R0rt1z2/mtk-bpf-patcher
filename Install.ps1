...
if (-Not $per.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
  ...
  Invoke-WebRequest -Uri https://github.com/R0rt1z2/mtk-bpf-patcher/archive/refs/heads/main.zip -OutFile dist.zip
  ...
  mv -Force mtk-bpf-patcher\mtk-bpf-patcher-main\* mtk-bpf-patcher\; rm -Force mtk-bpf-patcher\mtk-bpf-patcher-main
  ...
  LogToConsole 3 "Using $MtKBpfPatcherPath as the default path!"
